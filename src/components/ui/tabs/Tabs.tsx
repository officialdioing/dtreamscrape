  ...
  ({ className, variant = "default", ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        variant === "default" ? "bg-muted" : "gap-10 bg-transparent rounded-none w-full flex-wrap justify-start",
        className
      )}
      {...props}
    />
